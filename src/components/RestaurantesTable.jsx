  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const dataToSend = {
        ...
        descripcion_codigo_promocional: formData.descripcion_codigo_promocional || null
      }
      
      console.log('Datos a enviar:', dataToSend)
      
      const response = await apiService.post('/restaurantes', dataToSend, token)
      ...
      if (response && (response.status === 201 || response.status === 200 || response.success)) {
        ...
        alert('Error: No se pudo crear el restaurante. Respuesta inesperada del servidor.')
      }
    } catch (err) {
                ...
                <div className="modal-body">
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      ...
                      <select
                        className={`form-select ${formErrors.estatus ? 'is-invalid' : ''}`}
                        name="estatus"
                      ...
                      {formErrors.estatus && (
                        <div className="invalid-feedback">{formErrors.estatus}</div>
                      )}
                    </div>
                    ...
                    <div className="col-md-6">
                      ...
                      <input
                        type="email"
                        className={`form-control ${formErrors.correo_electronico ? 'is-invalid' : ''}`}
                      ...
                      {formErrors.correo_electronico && (
                        <div className="invalid-feedback">{formErrors.correo_electronico}</div>
                      )}
                    </div>
                    ...
                    <div className="col-12">
                      ...
                      <input
                        type="url"
                        className={`form-control ${formErrors.pagina_web ? 'is-invalid' : ''}`}
                        name="pagina_web"
                      ...
                      {formErrors.pagina_web && (
                        <div className="invalid-feedback">{formErrors.pagina_web}</div>
                      )}
                    </div>
                    ...
                    <div className="col-md-6">
                      ...
                      <input
                        type="text"
                        className={`form-control ${formErrors.codigo_promocional ? 'is-invalid' : ''}`}
                      ...
                      {formErrors.codigo_promocional && (
                        <div className="invalid-feedback">{formErrors.codigo_promocional}</div>
                      )}
                    </div>
                    ...
                    <div className="col-12">
                      ...
                      <textarea
                        className={`form-control ${formErrors.descripcion_codigo_promocional ? 'is-invalid' : ''}`}
                      ...
                      {formErrors.descripcion_codigo_promocional && (
                        <div className="invalid-feedback">{formErrors.descripcion_codigo_promocional}</div>
                      )}
                    </div>
