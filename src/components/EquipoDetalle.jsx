    ...
    <div className="equipos-table-container">
        ...
        <div className="card-body py-3">
          <div className="row g-3">
            <div className="col-md-6">
              <label className="form-label fw-semibold text-dark mb-2">Nombre del Equipo</label>
              {editMode ? (
                <input
                  type="text"
                  className="form-control"
                  value={equipo.nombre_equipo || ''}
                  onChange={(e) => setEquipo({...equipo, nombre_equipo: e.target.value})}
                />
              ) : (
                <p className="mb-0 fs-6 fw-bold text-primary">{equipo.nombre_equipo}</p>
              )}
            </div>
            <div className="col-md-6">
              <label className="form-label fw-semibold text-dark mb-2">Entidad Federativa</label>
              {editMode ? (
                <input
                  type="text"
                  className="form-control"
                  value={equipo.entidad_federativa || ''}
                  onChange={(e) => setEquipo({...equipo, entidad_federativa: e.target.value})}
                />
              ) : (
            ...
            <div className="col-md-6">
              ...
              {editMode ? (
                <select
                  ...
                  onChange={(e) => setEquipo({...equipo, estatus_del_equipo: e.target.value})}
                >
            ...
            <div className="col-md-6">
              <label className="form-label fw-semibold text-dark mb-2">Fecha de Creación</label>
        ...
        <div className="card-body py-3">
          <div className="row g-3">
            <div className="col-md-4">
              <label className="form-label fw-semibold text-dark mb-2">Nombre del Anfitrión</label>
              {editMode ? (
                <input
                  type="text"
                  className="form-control"
                  value={equipo.nombre_anfitrion || ''}
                  onChange={(e) => setEquipo({...equipo, nombre_anfitrion: e.target.value})}
                />
              ) : (
                <p className="mb-0 fs-6 fw-bold text-success">{equipo.nombre_anfitrion}</p>
              )}
            </div>
            <div className="col-md-4">
              ...
              {editMode ? (
                <input
                  ...
                  onChange={(e) => setEquipo({...equipo, telefono_anfitrion: e.target.value})}
                />
              ) : (
            ...
            <div className="col-md-4">
              ...
              {editMode ? (
                <input
                  ...
                  onChange={(e) => setEquipo({...equipo, correo_anfitrion: e.target.value})}
                />
              ) : (
                <p className="mb-0 fs-6">
      ...
      <div className="card mb-3 shadow-sm border-0">
        ...
        <div className="card-body py-3">
          <div className="row g-3">
            <div className="col-md-6">
              <label className="form-label fw-semibold text-dark mb-2">Nombre del Evento</label>
              <p className="mb-0 fs-6 fw-bold text-info">{equipo.evento?.nombre_evento}</p>
            </div>
            <div className="col-md-6">
              <label className="form-label fw-semibold text-dark mb-2">Sede del Evento</label>
              <p className="mb-0 fs-6">
            ...
            <div className="col-md-6">
              <label className="form-label fw-semibold text-dark mb-2">Fecha de Inicio</label>
              <p className="mb-0 fs-6">
            ...
            <div className="col-md-6">
              <label className="form-label fw-semibold text-dark mb-2">Fecha de Fin</label>
              <p className="mb-0 fs-6">
        ...
        <div className="card-body py-3">
          {equipo.participantes && equipo.participantes.length > 0 ? (
              ...
              <table className="table table-hover mb-0">
                <thead className="table-light">
                  <tr>
                    ...
                    {editMode && <th className="border-0 py-2 px-3">Acciones</th>}
                  </tr>
                </thead>
                <tbody>
                    ...
                    <tr key={participante.id}>
                      ...
                      <td className="py-2 px-3">
                        {editMode ? (
                          ...
                          <span className="badge bg-primary">{participante.rol_participante}</span>
                        )}
                      </td>
                      <td className="py-2 px-3">
                        {editMode ? (
                      ...
                      <td className="py-2 px-3">
                        {editMode ? (
                          ...
                          <span className="badge bg-info">{participante.semestre_participante}</span>
                        )}
                      </td>
                      {editMode && (
                        <td className="py-2 px-3">
            ...
            <div className="text-center py-4">
              ...
              <p className="text-muted mb-0">No hay participantes registrados</p>
            </div>
          )}
        </div>
      </div>
                    ...
                    <tr key={acompanante.id}>
                      ...
                      <td className="py-2 px-3">
                        {editMode ? (
                          ...
                          <span className="badge bg-info">{acompanante.rol}</span>
                        )}
                      </td>
                      <td className="py-2 px-3">
                        {editMode ? (
                  ...
                  <div className="card border-0 shadow-sm h-100">
                    ...
                    <div className="card-body py-2">
                      {editMode ? (
                        ...
                        <h6 className="fw-bold text-dark mb-2">{receta.descripcion}</h6>
                      )}
